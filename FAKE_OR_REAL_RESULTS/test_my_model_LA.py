...
la_root = r"C:\Users\Shivaay Dhondiyal\Desktop\shivaay\coding\2_projects\9_deepfake_paper\LA"
...
logs_root = os.path.join(os.path.dirname(__file__), 'FOR_logs')
